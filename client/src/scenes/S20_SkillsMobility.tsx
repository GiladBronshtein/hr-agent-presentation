        ...
        <div style={{ paddingTop: 'clamp(1.5rem,3cqw,3rem)' }} className="w-full max-w-6xl space-y-8">
          ...
          <div className="grid grid-cols-2 gap-6">
            <GlassCard>
              ...
              <p className="text-white/70 text-3xl leading-relaxed">הזדמנויות נסתרות</p>
            </GlassCard>
            <GlassCard style={{ background: '#10B98110', border: '1px solid #10B98125' }}>
              ...
              <p className="text-white font-medium text-3xl leading-relaxed">המלצה מותאמת לפרופיל</p>
            </GlassCard>
          </div>
          <div className="p-6 rounded-xl" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}>
            <p className="text-white/70 text-3xl leading-relaxed">חיבור עובדים להזדמנויות, המלצה בלבד</p>
          </div>
          <div className="flex items-start gap-5 p-6 rounded-xl" style={{ background: 'rgba(244,63,94,0.08)', border: '1px solid rgba(244,63,94,0.15)' }}>
            ...
            <p className="text-white/60 text-3xl">לא מחליט על קידום, שכר או סיום</p>
          </div>
        </div>
      </ContentLayout>
    </SceneBase>
