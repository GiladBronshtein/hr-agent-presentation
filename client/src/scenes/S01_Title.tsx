  ...
  return (
    <SceneBase>
      ...
      <div dir="rtl" style={{
        ...
        {/* Eyebrow badges */}
        <div className="animate-fade-in-up stagger-1" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem', marginBottom: 'clamp(1.5rem, 3vw, 3rem)', flexWrap: 'wrap' }}>
          <div style={{
            ...
            <span style={{ fontSize: 'clamp(1rem, 1.2vw, 1.1rem)', fontWeight: 700, color: '#818CF8', fontFamily: "'Space Grotesk', sans-serif", letterSpacing: '0.1em' }}>
          ...
          <div style={{
            ...
            <span style={{ fontSize: 'clamp(1rem, 1.2vw, 1.1rem)', fontWeight: 600, color: '#22D3EE', fontFamily: "'Space Grotesk', sans-serif" }}>
              גלעד ברונשטיין
            </span>
          </div>
        </div>
        ...
        <div className="animate-fade-in-up stagger-2" style={{ marginBottom: 'clamp(0.25rem, 1vw, 1rem)' }}>
          <h1 style={{
        ...
        <div className="animate-fade-in-up stagger-3" style={{ marginBottom: 'clamp(1.5rem, 3vw, 3.5rem)' }}>
          <h1 style={{
            fontFamily: "'Space Grotesk', 'Heebo', sans-serif",
            fontSize: 'clamp(5rem, 12vw, 11rem)',
            fontWeight: 900, lineHeight: 0.88, letterSpacing: '-0.05em',
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginTop: '0.75rem' }}>
            <div style={{ height: '4px', width: 'clamp(4rem, 10vw, 9rem)', background: 'linear-gradient(90deg, #6366F1, #22D3EE)', borderRadius: '3px' }} />
          </div>
        </div>
        ...
        {/* Chapter pills */}
        <div className="animate-fade-in-up stagger-5" style={{ display: 'flex', justifyContent: 'center', gap: 'clamp(0.625rem, 1.2vw, 1rem)', flexWrap: 'wrap' }}>
          {CHAPTERS.map((ch, i) => (
            <div key={ch.label} style={{
              ...
              <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 'clamp(1.1rem, 1.5vw, 1.4rem)', fontWeight: 800, color: ch.color, opacity: 0.6, letterSpacing: '0.05em' }}>{ch.num}</span>
              <div style={{ textAlign: 'right' }}>
                <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 'clamp(1rem, 1.6vw, 1.4rem)', fontWeight: 700, color: 'white', letterSpacing: '-0.01em' }}>{ch.label}</div>
                <div style={{ fontFamily: "'Heebo', sans-serif", fontSize: 'clamp(1rem, 1.1vw, 1rem)', color: 'rgba(255,255,255,0.38)', marginTop: '1px' }}>{ch.desc}</div>
              </div>
            </div>
          ))}
        </div>
