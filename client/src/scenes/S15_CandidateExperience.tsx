        ...
        <div className="w-full max-w-3xl space-y-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <GlassCard>
              ...
              <p className="text-white/70 text-base leading-relaxed">עיכוב שבועות ללא עדכון</p>
            </GlassCard>
            <GlassCard style={{ background: '#70D6A710', border: '1px solid #70D6A725' }}>
              ...
              <p className="text-white font-medium text-base leading-relaxed">עדכון מותאם תוך שעות</p>
            </GlassCard>
          </div>
          <div className="p-4 rounded-xl" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}>
            <p className="text-white/70 text-sm leading-relaxed">אוטומציה שולחת הודעה. אייג׳נט מבין איזו מתאימה.</p>
          </div>
          <div className="flex items-start gap-3 p-4 rounded-xl" style={{ background: 'rgba(255,107,107,0.08)', border: '1px solid rgba(255,107,107,0.15)' }}>
            ...
            <p className="text-white/60 text-sm">דחיות ללא אישור אנושי — אסור</p>
          </div>
        </div>
      </ContentLayout>
    </SceneBase>
